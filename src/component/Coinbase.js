...
import CoinbaseImg from '../image/coinbase-logo.png'
...
const Coinbase = () => {
   const navigate=useNavigate()
    ...
    <h2> Withdraw with Coinbase</h2> <img className='meta' src={CoinbaseImg} alt='metamask'/>
    </div>
    <div>
